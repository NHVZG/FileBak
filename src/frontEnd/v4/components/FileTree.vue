<template>
  <el-tree :props="treePropName" :data="treeData" ref="tree"  :filter-node-method="filterNode" @nodeClick="onNodeClick" :load="load" :lazy="lazy" @node-collapse="onExpand" @node-expand="onExpand" :default-expand-all="expandAll" ><!--default-expand-all-->
...
export default {
  ...
  methods:{
    ...
    onExpand(data,node,tree,event){
      this.expand(data,node,tree,event);
    }
  }
}
</script>
